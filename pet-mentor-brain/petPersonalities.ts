// ============================================================
// BROskiPet Mentor Personalities
// Generated: 2026-06-02
// All 10 species — system prompts + example lines
// Used by: pet-mentor-chat Edge Function
// ============================================================
...
// Helper — get personality by species ID
export function getPetPersonality(id: SpeciesId): PetPersonality {
  return PET_PERSONALITIES[id]
}

// Helper — build a filled system prompt with student context
