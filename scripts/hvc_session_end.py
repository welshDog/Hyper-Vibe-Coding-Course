#!/usr/bin/env python3
"""HyperFocus Z0ne - Course Session End Hook.

Reads the .focus_session_start marker written by hvc_session_start.py,
...
def main() -> int:
    now = datetime.now()
    print("\n[SESSION END] HyperFocus Z0ne -- Course")
    print("-" * 40)
    ...
    if start:
        ...
        print("   Duration: unknown (hvc_session_start was not run this session)")
    ...
    print()
    print("PASS  Course session ended. Great work BROski forever!\n")
    return 0
