#!/usr/bin/env python3
"""HyperFocus Z0ne - Course Compose Validator.
...
Usage:
    ...
    python scripts/hvc_compose_validator.py /abs/path/to/compose.yml
"""
...
def main() -> int:
    if len(sys.argv) < 2:
        print("Usage: python scripts/hvc_compose_validator.py <compose-file>")
        return 2

    compose_path = _resolve_compose(sys.argv[1])

    print("\n[COMPOSE VALIDATOR] HyperFocus Z0ne Course -- " + sys.argv[1])
    print("-" * 40)
