...
export type SpeciesConfig = {
  ...
  /** XP required to unlock this species in the picker. Omit (or 0) = always available. Tune freely. */
  unlockXp?:        number
}

export const SPECIES: readonly SpeciesConfig[] = [
  { id: 'apex_dragon',         displayName: 'Apex Dragon',         emoji: '🐲', imageUrl: '/pets/apex_dragon.png',         babyMetadataCid: 'bafkreifmbfuzdcy3rmaqywbymt4y23tfqx3fcu2bgv4n3vtbuj77yqqzte', unlockXp: 3000 },
  ...
  { id: 'cyber_fox',           displayName: 'Cyber Fox',           emoji: '🦊', imageUrl: '/pets/cyber_fox.png',           babyMetadataCid: 'bafkreigyzfipicwnwllxfkll55mbaztfhqehw3os5vmiezksntpxe7iaua', unlockXp: 500  },
  ...
  { id: 'hyperfocus_horse',    displayName: 'Hyperfocus Horse',    emoji: '🐴', imageUrl: '/pets/hyperfocus_horse.png',    babyMetadataCid: 'bafkreib6pnkjhzzwbrmrefulglijgelhbwt7sbmommdtm2etrdp44v2zay', unlockXp: 1500 },
